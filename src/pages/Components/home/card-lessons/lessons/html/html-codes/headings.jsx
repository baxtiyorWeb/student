        ...
        <code>
          <pre>
            <div className="html-code">
              <span className="code-length">1</span>
            ...
            <div className="html-code">
              <span className="code-length">2</span>
              <div className="opened-tag">
                <span className="r">{"<"}</span>
            ...
            <div className="html-code">
              <span className="code-length">3</span>
              <div className="opened-tag">
                <span className="r">{"<"}</span>
            ...
            <div className="html-code">
              <span className="code-length">4</span>
              <div className="opened-tag">
                <span className="r">{"<"}</span>
            ...
            <div className="html-code">
              <span className="code-length">5</span>
              <div className="opened-tag">
                <span className="r">{"<"}</span>
            ...
            <div className="html-code">
              <span className="code-length">6</span>
              <div className="opened-tag">
                <span className="r">{"<"}</span>
